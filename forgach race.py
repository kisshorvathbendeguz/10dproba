...
iro.pendown()
iro.write('Forgach Race', font=("Comic Sans MS", 60, "normal"))
time.sleep(2)
iro.clear()
iro.penup()
iro.goto(-50, -50)
...
pilotak_adatai = [['Márki-Zay Péter', 'blue', 'orange'],
                ['Orbán Viktor', 'red', 'grey'],
                ['Gyurcsány Ferenc', 'yellow', 'red'],
                ['Bajnai Gordon', 'black', 'grey'],
                ['Széll Bernadett', 'blue', 'black']]
